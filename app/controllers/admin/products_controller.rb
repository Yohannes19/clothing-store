  ...
  def create
    ...
    respond_to do |format|
      if @admin_product.save
        format.html { redirect_to admin_products_url(@admin_product), notice: "Product was successfully created." }
  ...
  def update
    respond_to do |format|
      if @admin_product.update(admin_product_params)
        format.html { redirect_to admin_products_url(@admin_product), notice: "Product was successfully updated." }
